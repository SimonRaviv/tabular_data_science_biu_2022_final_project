"""
@brief This module supports the emperical distribution comparisons.

It uses the @ref tds_rg_module module for calculations, statistical tests and plotting utils.
"""
